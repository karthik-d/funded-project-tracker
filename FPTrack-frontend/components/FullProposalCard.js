...
function Idlist_usercard(props) {
  console.log("IDlist", props.props[0]);
  return props.props.map((obj) => {
    console.log("obj", obj);
    return <Usercard props={obj[0]} />;
  });
}
...
export default function FullProposal(props) {
  ...
  var res = arrayBufferToBase64(
    props.props.pdf_document != null ? props.props.pdf_document.data : "Nothing"
  );
    ...
    <div className={styles.main_container}>
      ...
      <div className={styles.table_container}>
        <div className={styles.sub_table}>
          Budget requested: Rs
          <span className={styles.budget}>{props.props.budget}</span>
        </div>
        <div className={styles.sub_table}>
          Proposal.pdf:
          <a
      ...
      <Leader props={props.props.leader} />
      <Members props={props.props.members} />
      <Supervisors props={props.props.supervisors} />
    </div>
  );
}
